...
class Urls(object):
    ...
    def __init__(self, country=COUNTRY_USA):
        ...
        self.urls = {
            COUNTRY_USA: {
                'find_url' : f'{DOMAIN_BASE_US}store-locator?s={line1}&c={line2}&type={type}',
                'info_url' : f'{DOMAIN_BASE_US}store/{store_id}/profile',
                'menu_url' : f'{DOMAIN_BASE_US}power/store/{store_id}/menu?lang={lang}&structured=true',
                'place_url' : f'{DOMAIN_BASE_US}power/place-order',
                'price_url' : f'{DOMAIN_BASE_US}power/price-order',
                ...
                'validate_url' : f'{DOMAIN_BASE_US}power/validate-order',
                'coupon_url' : f'{DOMAIN_BASE_US}power/store/{store_id}/coupon/{couponid}?lang={lang}',
            },
            COUNTRY_CANADA: {
                'find_url' : f'{DOMAIN_BASE_CA}power/store-locator?s={line1}&c={line2}&type={type}',
                'info_url' : f'{DOMAIN_BASE_CA}power/store/{store_id}/profile',
                'menu_url' : f'{DOMAIN_BASE_CA}power/store/{store_id}/menu?lang={lang}&structured=true',
                'place_url' : f'{DOMAIN_BASE_CA}power/place-order',
                'price_url' : f'{DOMAIN_BASE_CA}power/price-order',
                ...
                'validate_url' : f'{DOMAIN_BASE_CA}power/validate-order',
                'coupon_url' : f'{DOMAIN_BASE_CA}power/store/{store_id}/coupon/{couponid}?lang={lang}',
            }
        }
